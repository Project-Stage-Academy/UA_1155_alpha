...
class Project(models.Model):
    ...
    startup = models.ForeignKey(
        Startup, on_delete=models.CASCADE, related_name="projects"
    )
    ...
    budget_ready = models.DecimalField(
    ...
    subscribers = models.ManyToManyField(
        "investors.Investor", related_name="subscribed_projects", blank=True
    )
    investors = models.ManyToManyField(
        "investors.Investor", related_name="participated_projects", blank=True
    )
